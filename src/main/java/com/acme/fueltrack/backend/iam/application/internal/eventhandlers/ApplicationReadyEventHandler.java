package com.acme.fueltrack.backend.iam.application.internal.eventhandlers;
...
public class ApplicationReadyEventHandler {
    ...
    public ApplicationReadyEventHandler(ProfileCommandService profileCommandService) {
    ...
    public void on(ApplicationReadyEvent event) {
        ...
        profileCommandService.handle(seedRolesCommand);
